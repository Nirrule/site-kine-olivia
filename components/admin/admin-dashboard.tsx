...
import { KinesitherapyEditor } from "./editors/kinesitherapy-editor";
import { MetadataEditor } from "./editors/metadata-editor";
import { MethodologyEditor } from "./editors/methodology-editor";
import { PracticalInfoEditor } from "./editors/practical-info-editor";
import { SecurityEditor } from "./editors/security-editor";
import { ServicesEditor } from "./editors/services-editor";
import { SpecializationsEditor } from "./editors/specializations-editor";
...
export function AdminDashboard({ onLogout }: AdminDashboardProps) {
 ...
 const tabs = [
  ...
  { id: "specializations", label: "Spécialisations", icon: ClipboardList },
  { id: "services", label: "Services", icon: Settings },
  { id: "kinesitherapy", label: "Kinésithérapie", icon: Activity },
  { id: "methodology", label: "Méthodo", icon: BookOpen },
  { id: "practicalInfo", label: "Infos pratiques", icon: Info },
    ...
    <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
     ...
     <Card className="border-0 shadow-sm">
      <CardContent className="p-6">
       <TabsList className="grid grid-cols-6 lg:grid-cols-15 gap-2 h-auto bg-transparent">
        {tabs.map((tab) => (
         <TabsTrigger
          key={tab.id}
          value={tab.id}
     ...
     <TabsContent value="specializations">
      <SpecializationsEditor config={config} onUpdate={updateConfig} />
     </TabsContent>
     ...
     <TabsContent value="kinesitherapy">
      <KinesitherapyEditor config={config} onUpdate={updateConfig} />
     </TabsContent>

     <TabsContent value="methodology">
      <MethodologyEditor config={config} onUpdate={updateConfig} />
     </TabsContent>

     <TabsContent value="practicalInfo">
      <PracticalInfoEditor config={config} onUpdate={updateConfig} />
     </TabsContent>
