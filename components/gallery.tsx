...
export function Gallery({ config }: GalleryV2Props) {
	...
	const categories = [
		...
		{ id: "project1", label: "Projet 1" },
		{ id: "project2", label: "Projet 2" },
		{ id: "project3", label: "Projet 3" },
		{ id: "project4", label: "Projet 4" },
	];
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-muted-foreground max-w-3xl mx-auto">
						Chaque projet est unique et reflète notre passion et notre expertise
					</p>
